...
// Gutenberg & Richter (1956): log10(Es [J]) = 5.24 + 1.44·M
function seismicMoment(mag) { return Math.pow(10, 1.5 * mag + 9.1); }
function seismicEnergy(mag) { return Math.pow(10, 5.24 + 1.44 * mag); }
function fmtSci(v) {
...
function renderFromCurrentData(opts={}){
  ...
  // Rebuild charts and refresh country list after any data render
  if (typeof buildCharts === "function") setTimeout(buildCharts, 60);
  if (typeof buildCountryList === "function") setTimeout(buildCountryList, 80);
}
